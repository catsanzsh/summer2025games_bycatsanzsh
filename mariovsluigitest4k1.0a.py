...
class FrostyBrawl:
    ...
    def draw_menu(self):
        ...
        # Title
        title = self.title_font.render("FROSTY BRAWL", True, (255, 255, 255))
        title_shadow = self.title_font.render("FROSTY BRAWL", True, (50, 80, 150))
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("Frosty Brawl")
    game = FrostyBrawl(win)
    game.run()
